...
(define-constant TRADER-3 'ST2JHG361ZXG51QTKY2NQCVBPPRRE2KZB1HR05NNC)

(define-constant RECEIVER-1 'STNHKEPYEPJ8ET55ZZ0M5A34J0R3N5FM2CMMMAZ6)
...
(define-private (deposit-escrow) 
    (begin 
        ...
        (if (is-eq tx-sender TRADER-2)
            (begin 
                (unwrap! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.punks transfer u4 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
            )
            true        
        ) 
        (if (is-eq tx-sender TRADER-3)
            (begin 
                (unwrap! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.whales transfer u1 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
                (unwrap! (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.whales transfer u3 tx-sender (as-contract tx-sender)) (err ERR_FAILED_TO_ESCROW_NFT))
            )
            true        
        )
...
(define-private (release-escrow) 
    (begin
        (unwrap-panic (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.whales transfer u1 tx-sender TRADER-1)))    
        (unwrap-panic (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.punks transfer u4 tx-sender TRADER-1)))

        (unwrap-panic (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.whales transfer u3 tx-sender TRADER-2)))
        (unwrap-panic (as-contract (stx-transfer? u450000 tx-sender TRADER-2)))

        (unwrap-panic (as-contract (stx-transfer? u500000 tx-sender TRADER-3)))
...
(define-private (return-escrow) 
    (begin 
        ...
        (if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-2)) TRADER_STATE_CONFIRMED)
            (begin 
                (unwrap-panic (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.punks transfer u4 tx-sender TRADER-2)))
            )
            true        
        ) 
        (if (is-eq (default-to ERR_IS_NOT_TRADER (map-get? TraderState TRADER-3)) TRADER_STATE_CONFIRMED)
            (begin 
                (unwrap-panic (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.whales transfer u1 tx-sender TRADER-3)))
                (unwrap-panic (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.whales transfer u3 tx-sender TRADER-3)))
            )
            true        
        )
